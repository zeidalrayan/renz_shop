      ...
      <div class="md:px-12 lg:px-28">
        <div class="container m-auto space-y-6 text-gray-600 dark:text-gray-300 ">
          <img
            src={imageSrc}
            alt="logo tailus"
            class="m-auto w-40 max-md:w-24"
          />
          <ul
            role="list"
            class="flex flex-col capitalize items-center justify-center gap-4 py-4 sm:flex-row sm:gap-8"
          >
            <Link to={"/"}>
              <li>
                <a
            ...
            <li>
              <Link
                to={"/product"}
                class={`${
                  location.pathname === "/product" ? "text-sky-600 " : ""
                }block md:px-4 transition hover:text-sky-600 dark:hover:text-primaryLight`}
              >
                <span>product</span>
              </Link>
          ...
          <div class="text-center">
            <span class="text-sm tracking-wide">
              Copyright © Renz shop <span id="year"></span> | All right reserved
            </span>
          </div>
        </div>
      </div>
